...
// Menambahkan event listener pada form pesan dan doa
document.addEventListener("DOMContentLoaded", function () {
  var form = document.getElementById('pesanDoaForm');
  if (form) {
    form.addEventListener('submit', function(event) {
      event.preventDefault();
      var nama = document.getElementById('nama').value;
      var pesan = document.getElementById('pesan').value;
      // Menambahkan pesan dan doa ke daftar
      var listPesan = document.getElementById('listPesan');
      if (listPesan) {
        var li = document.createElement('li');
        li.innerHTML = '<strong>' + nama + '</strong>: ' + pesan;
        listPesan.appendChild(li);
      }
      // Menampilkan pesan terkirim
      var pesanTerkirim = document.getElementById('pesanTerkirim');
      if (pesanTerkirim) {
        pesanTerkirim.style.display = 'block';
      }
      // Mengosongkan form
      document.getElementById('pesanDoaForm').reset();
    });
  }
});